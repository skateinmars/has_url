...
URL scheme will be checked and added if necessary, using Addressable::URI.
A raw_#{attribute} will also be added to display the url without HTTP(S) scheme or trailing slash
...
* Shoulda for unit tests
* Addressable for URI parsing

== TODO

* Make it a gem (with up to date gem depencies)
* More tests
